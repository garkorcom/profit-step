...
exports.onBlueprintJobCreated = exports.onNoteCreated = exports.onReceiptUpdate = exports.onWorkSessionUpdate = exports.onWorkSessionCreate = exports.generateDailyPayroll = exports.closePayrollPeriod = exports.forceFinishAllSessions = exports.onAdvanceCreated = exports.generateRecurringTasks = exports.weeklyTaskSummary = exports.taskHealthCheck = exports.autoTaskPriority = exports.sendDailyTaskDigest = exports.sendDeadlineReminders = exports.scheduledAutoStopStaleTimers = exports.autoCloseStaleSessions = exports.finalizeExpiredSessions = exports.onCostsBotMessage = exports.onWorkerBotMessage = exports.parseClientWebsite = exports.parseSmartInput = exports.estimateTask = exports.generateLeadSummary = exports.sendWorkerMessage = exports.sendMessage = exports.onWhatsAppMessage = exports.onLeadCreate = exports.updateCompanyMemberCount_v2 = exports.trackUserActivation_v2 = exports.logUserUpdates_v2 = exports.incrementLoginCount_v2 = exports.inviteUser = exports.adminDeleteUser = exports.onUserDelete = exports.onUserCreate = exports.admin_manageUser = exports.admin_createUserWithPassword = exports.logPaginationMetrics = exports.diagnoseBot = exports.logInvitationAccepted = exports.logInvitationSent = exports.logUserDeleted = exports.logUserCreated = exports.brevoWebhookHandler = exports.trackFirstInvite = exports.initializeUserActivation = exports.aggregateEngagementMetrics = exports.aggregateGrowthMetrics = exports.processAvatar = void 0;
exports.getNpsStatus = exports.triggerNps = exports.getWarrantyTasks = exports.createWarrantyTask = exports.updatePaymentMilestone = exports.getPaymentSchedule = exports.createPaymentSchedule = exports.updateWorkAct = exports.getWorkActs = exports.createWorkAct = exports.updatePunchListItem = exports.getPunchLists = exports.createPunchList = exports.cleanupIdempotencyKeys = exports.invalidateClientCache = exports.agentApi = exports.modifyAiTask = exports.confirmAiTask = exports.generateAiTask = exports.categorizeBankTransactions = exports.uploadBankStatement = exports.onCostUpdate = exports.onCostCreated = exports.onTaskCreate = exports.onTaskUpdate = exports.sendShiftHandoff = exports.getTeamTaskOverview = exports.linkCostToTask = exports.getTaskFinancials = exports.createProjectFromTemplate = exports.moveGtdTask = exports.scheduledDayPlan = exports.generateDayPlan = exports.generateProjectDigest = exports.generatePriceEstimate = exports.syncActiveTimer = exports.onSessionChangeUpdateCost = exports.verifyTask = exports.submitForReview = exports.checkLongBreaks = exports.updateWorkSession = exports.mergeNotes = exports.splitChecklistItem = exports.verifyEstimatePlausibilityCallable = exports.analyzeBlueprintV3Callable = exports.extractBuildingContextCallable = exports.auditBlueprintTakeoff = exports.refineAnalysisCallable = exports.analyzePageCallable = exports.onBlueprintBatchCreated = void 0;
exports.triggerAlerts = exports.notifyAlerts = exports.getPlanVsFact = void 0;
...
var adminManageUser_1 = require("./adminManageUser");
Object.defineProperty(exports, "admin_manageUser", { enumerable: true, get: function () { return adminManageUser_1.admin_manageUser; } });
...
var parseClientWebsite_1 = require("./callable/ai/parseClientWebsite");
Object.defineProperty(exports, "parseClientWebsite", { enumerable: true, get: function () { return parseClientWebsite_1.parseClientWebsite; } });
...
var autoStopStaleTimers_1 = require("./scheduled/autoStopStaleTimers");
Object.defineProperty(exports, "scheduledAutoStopStaleTimers", { enumerable: true, get: function () { return autoStopStaleTimers_1.scheduledAutoStopStaleTimers; } });
...
var dailyTaskDigest_1 = require("./scheduled/dailyTaskDigest"); // Morning task digest at 7:00 AM
Object.defineProperty(exports, "sendDailyTaskDigest", { enumerable: true, get: function () { return dailyTaskDigest_1.sendDailyTaskDigest; } });
var autoTaskPriority_1 = require("./scheduled/autoTaskPriority"); // Auto-escalate priority by deadline
Object.defineProperty(exports, "autoTaskPriority", { enumerable: true, get: function () { return autoTaskPriority_1.autoTaskPriority; } });
var taskAutomation_1 = require("./scheduled/taskAutomation"); // Stale/overrun/WIP checks every 6h
Object.defineProperty(exports, "taskHealthCheck", { enumerable: true, get: function () { return taskAutomation_1.taskHealthCheck; } });
var taskAutomation_2 = require("./scheduled/taskAutomation"); // Friday 17:00 weekly report
Object.defineProperty(exports, "weeklyTaskSummary", { enumerable: true, get: function () { return taskAutomation_2.weeklyTaskSummary; } });
var taskAutomation_3 = require("./scheduled/taskAutomation"); // Daily recurring task generation
Object.defineProperty(exports, "generateRecurringTasks", { enumerable: true, get: function () { return taskAutomation_3.generateRecurringTasks; } });
var taskAutomation_4 = require("./scheduled/taskAutomation"); // PO → auto-task trigger
Object.defineProperty(exports, "onAdvanceCreated", { enumerable: true, get: function () { return taskAutomation_4.onAdvanceCreated; } });
...
var onBlueprintJobCreated_1 = require("./triggers/firestore/onBlueprintJobCreated");
Object.defineProperty(exports, "onBlueprintJobCreated", { enumerable: true, get: function () { return onBlueprintJobCreated_1.onBlueprintJobCreated; } });
var onBlueprintBatchCreated_1 = require("./triggers/firestore/onBlueprintBatchCreated");
Object.defineProperty(exports, "onBlueprintBatchCreated", { enumerable: true, get: function () { return onBlueprintBatchCreated_1.onBlueprintBatchCreated; } });
var analyzePage_1 = require("./callable/ai/analyzePage");
...
var generateProjectDigest_1 = require("./exports/generateProjectDigest");
Object.defineProperty(exports, "generateProjectDigest", { enumerable: true, get: function () { return generateProjectDigest_1.generateProjectDigest; } });
// GTD: AI Day Planner
...
var projectTemplates_1 = require("./callable/gtd/projectTemplates");
Object.defineProperty(exports, "createProjectFromTemplate", { enumerable: true, get: function () { return projectTemplates_1.createProjectFromTemplate; } });
var taskFinancials_1 = require("./callable/gtd/taskFinancials");
Object.defineProperty(exports, "getTaskFinancials", { enumerable: true, get: function () { return taskFinancials_1.getTaskFinancials; } });
Object.defineProperty(exports, "linkCostToTask", { enumerable: true, get: function () { return taskFinancials_1.linkCostToTask; } });
var teamOverview_1 = require("./callable/gtd/teamOverview");
Object.defineProperty(exports, "getTeamTaskOverview", { enumerable: true, get: function () { return teamOverview_1.getTeamTaskOverview; } });
var shiftHandoff_1 = require("./scheduled/shiftHandoff");
Object.defineProperty(exports, "sendShiftHandoff", { enumerable: true, get: function () { return shiftHandoff_1.sendShiftHandoff; } });
// ========================================
...
// ========================================
var generateAiTask_1 = require("./callable/ai/generateAiTask");
Object.defineProperty(exports, "generateAiTask", { enumerable: true, get: function () { return generateAiTask_1.generateAiTask; } });
