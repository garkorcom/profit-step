/**
 * Seeding script for DevLog blog posts
 * Run: node scripts/seed-devlog.js
 * 
 * Creates 5 published articles in the `dev_logs` Firestore collection
 * based on real Profit Step development milestones.
 */

const admin = require('firebase-admin');
const path = require('path');

// Initialize Firebase Admin with the service account from functions dir
...
\`\`\``,
        ...
        isPublished: true,
        publishedAt: admin.firestore.Timestamp.fromDate(new Date('2026-01-15T10:00:00Z')),
...
\`\`\``,
        ...
        isPublished: true,
        publishedAt: admin.firestore.Timestamp.fromDate(new Date('2026-01-23T14:00:00Z')),
        createdAt: admin.firestore.Timestamp.fromDate(new Date('2026-01-23T13:00:00Z')),
    },
...
- Сравнение «AI estimate vs. actual» в реальном времени`,
        ...
        isPublished: true,
        publishedAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-05T12:00:00Z')),
        createdAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-05T11:00:00Z')),
    },
...
- \`private\`: 0%`,
        ...
        isPublished: true,
        publishedAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-10T16:00:00Z')),
        createdAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-10T15:00:00Z')),
    },
...
\`\`\``,
        ...
        isPublished: true,
        publishedAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-17T18:00:00Z')),
        createdAt: admin.firestore.Timestamp.fromDate(new Date('2026-02-17T17:00:00Z')),
    },
];
