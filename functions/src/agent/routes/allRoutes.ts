/**
 * All API Routes — extracted from agentApi.ts for modularization
 * These routes are registered AFTER auth + rate-limit middleware
 */
...
import {
  ...
  getCachedClients, fuzzySearchClient, searchClientByAddress,
  autoCreateClientByAddress, resolveOwnerCompanyId,
  COST_CATEGORY_LABELS, Fuse,
} from '../routeContext';
import {
