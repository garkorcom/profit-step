...
> ⚠️ **LEGACY — зафиксировано на API v4.2.0 (2026-04-02). Актуально:** API v4.5.0.
> Для текущих endpoint'ов см. https://profit-step.web.app/api/docs/spec.json
> и [`docs/CRM_API_GUIDE.md`](../docs/CRM_API_GUIDE.md).
